    ...
    public function update(Request $request, Course $course)
    {
        ...
        foreach ($request->schedules as $i => $current) {
            ...
            foreach ($request->schedules as $j => $compare) {
                ...
                if (
                    ...
                    return back()
                        ->withInput()
                        ->with('error', "Duplicate/Overlapping schedule found on {$current['day']}.");
                }
            }
        }
        ...
        try {
            ...
            if ($request->hasFile('preview_video')) {
                ...
                $data['preview_video'] = $request
                    ->file('preview_video')
                    ->store('course/previews', 'public');
            }
            ...
            DB::commit();
            return redirect()
                ->route('instructor.course.edit', $course)
