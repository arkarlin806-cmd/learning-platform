...
<div class="mt-8 space-y-5">
    ...
    <div class="p-6 bg-white rounded-2xl shadow border">
        ...
        <video
            ...
            preload="metadata"
            playsinline
            class="mt-5 w-full max-h-[500px] bg-black rounded-xl">
            <source
                src="{{ $lesson->video_url }}"
                type="video/mp4">
        </video>
        ...
        <div class="mt-5 p-4 bg-yellow-50 rounded-xl">
            Video URL is empty.
        </div>
    ...
    <div class="p-8 bg-red-50 rounded-2xl text-red-600">
        No lessons found.
    </div>
